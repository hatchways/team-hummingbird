...
visionRouter.post("/generalImageProps", auth, async (req, res) => {
...
visionRouter.post("/detectLabels", auth, async (req, res) => {
  const { imgURL = testImg } = req.query;
  console.log("the query is " + req.query.imgURL);
  const okGoogle = async (downloadedImg) => {
...
visionRouter.post("/detectLogos", auth, async (req, res) => {
...
visionRouter.post("/detectExplicit", auth, async (req, res) => {
  const { imgURL } = req.query;
  const okGoogle = async (downloadedImg) => {
